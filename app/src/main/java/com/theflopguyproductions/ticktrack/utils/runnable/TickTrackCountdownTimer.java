...
public abstract class TickTrackCountdownTimer extends Timer {
    private long totalTime, interval, delay;
    private TimerTask task;
    private long startTime = -1;
    private boolean restart = false, wasCancelled = false, wasStarted = false;

    public TickTrackCountdownTimer(long totalTime, long interval) {
        this(totalTime, interval, 0);
    }

    public TickTrackCountdownTimer(long totalTime, long interval, long delay) {
