...
import com.theflopguyproductions.ticktrack.ui.lottie.model.LottieCompositionCache;
import com.theflopguyproductions.ticktrack.ui.lottie.network.NetworkFetcher;
import com.theflopguyproductions.ticktrack.ui.lottie.parser.LottieCompositionMoshiParser;
...
import static com.theflopguyproductions.ticktrack.ui.lottie.parser.moshi.JsonReader.of;
import static com.theflopguyproductions.ticktrack.ui.lottie.utils.Utils.closeQuietly;
    ...
    try {
      ...
      while (entry != null) {
        ...
        if (entryName.contains("__MACOSX")) {
          ...
          JsonReader reader = of(buffer(source(inputStream)));
