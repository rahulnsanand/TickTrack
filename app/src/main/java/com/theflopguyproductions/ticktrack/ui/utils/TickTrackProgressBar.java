...
public class TickTrackProgressBar extends View {

    private static final String TAG = TickTrackProgressBar.class.getSimpleName();
     ...
     */
    public TickTrackProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * The constructor for the ProgressWheel
     */
    public TickTrackProgressBar(Context context) {
        super(context);
        setAnimationEnabled();
    }
