...
public class TickTrackScrollView extends NestedScrollView {
    ...
    public TickTrackScrollView(@NonNull Context context) {
        this(context, null);
    }

    public TickTrackScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TickTrackScrollView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
