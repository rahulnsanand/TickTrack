...
public class TickTrackCircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public TickTrackCircleImageView(Context context) {
        super(context);

        init();
    }

    public TickTrackCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TickTrackCircleImageView(Context context, AttributeSet attrs, int defStyle) {
