...
import com.theflopguyproductions.ticktrack.ui.lottie.model.animatable.AnimatableTextFrame;
...
import com.theflopguyproductions.ticktrack.ui.lottie.model.layer.Layer;
...
public class LayerParser {
  ...
  public static Layer parse(LottieComposition composition) {
    ...
    return new Layer(
        Collections.emptyList(), composition, "__container", -1,
        Layer.LayerType.PRE_COMP, -1, null, Collections.emptyList(),
        new AnimatableTransform(), 0, 0, 0, 0, 0,
        bounds.width(), bounds.height(), null, null, Collections.emptyList(),
