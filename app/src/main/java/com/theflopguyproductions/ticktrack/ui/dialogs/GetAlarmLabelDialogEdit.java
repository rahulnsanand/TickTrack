...
import com.theflopguyproductions.ticktrack.ui.alarm.activity.alarm.EditAlarmActivity;

import java.util.Objects;

public class GetAlarmLabelDialogEdit extends Dialog {
    ...
    public GetAlarmLabelDialogEdit(Activity activity){
        super(activity);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yesButton.setOnClickListener(view12 -> {
            ((EditAlarmActivity) activity).setLabel(alarmLabel.getText().toString());
            dismiss();
        });
